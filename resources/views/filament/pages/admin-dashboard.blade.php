<x-filament-panels::page>
    <style>
        ...
        .quick-stat-item.warning {
            background: linear-gradient(135deg, var(--warning-100), #fde68a);
        }

        .dark .quick-stat-item.warning {
            background: linear-gradient(135deg, rgb(217 119 6 / 0.2), rgb(245 158 11 / 0.2));
        }
        ...
        .quick-stat-item.warning .quick-stat-label { color: var(--warning-600); }
        ...
        .dark .quick-stat-item.warning .quick-stat-label { color: rgb(253 186 116); }
        ...
        .quick-stat-item.warning .quick-stat-value { color: var(--warning-600); }
        ...
        .dark .quick-stat-item.warning .quick-stat-value { color: rgb(253 186 116); }
