<x-filament-panels::page>
    ...
    <div class="kaprodi-dashboard">
        <!-- Welcome Banner -->
        <div class="welcome-banner">
            <h2>👋 Selamat Datang, {{ $userName }}</h2>
            <p>Dashboard Monitoring Mahasiswa & Dosen</p>
        </div>
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                ...
                <div class="metric-subtitle">Aktif monitoring</div>
            </div>

            <div class="metric-card success">
                <div class="metric-icon">✅</div>
                <div class="metric-label">Sesuai Jadwal</div>
        ...
        <div class="content-grid">
            ...
            <div class="card">
                ...
                <div class="quick-stats">
                    ...
                    <div class="quick-stat-item primary">
                        <div class="quick-stat-label">Bimbingan Dalam Review</div>
